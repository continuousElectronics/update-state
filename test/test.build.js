...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux */ \"./node_modules/redux/es/redux.js\");\n/* harmony import */ var redux_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! redux-logger */ \"./node_modules/redux-logger/dist/redux-logger.js\");\n/* harmony import */ var redux_logger__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(redux_logger__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _dev__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dev */ \"./dev.js\");\n/* harmony import */ var redux_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! redux-actions */ \"./node_modules/redux-actions/es/index.js\");\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n\n\n\nvar initState = {\n  counter: 10,\n  artists: {\n    meshuggah: {\n      albums: [\"Koloss\", \"Chaosphere\", \"Nothing\"]\n    }\n  }\n}; // If you follow the pattern of using an updater object as the payload of your object,\n// the below reducer could be the only redux reducer you have to write for your whole app.\n\nvar reducer = function reducer(state, _ref) {\n  var payload = _ref.payload;\n  if (!payload) return state;\n  return Object(_dev__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(state, payload);\n};\n\nvar store = Object(redux__WEBPACK_IMPORTED_MODULE_0__[\"createStore\"])(reducer, initState, Object(redux__WEBPACK_IMPORTED_MODULE_0__[\"applyMiddleware\"])(redux_logger__WEBPACK_IMPORTED_MODULE_1___default.a));\nvar incActions = Object(redux_actions__WEBPACK_IMPORTED_MODULE_3__[\"createActions\"])({\n  INCREMENT: function INCREMENT() {\n    var incAmount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;\n    return {\n      counter: function counter(amount) {\n        return amount + incAmount;\n      }\n    };\n  },\n  DECREMENT: function DECREMENT() {\n    var decAmount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;\n    return {\n      counter: function counter(amount) {\n        return amount - decAmount;\n      }\n    };\n  },\n  UPDATE_ARTICLE: function UPDATE_ARTICLE(id, updater) {\n    return {\n      articles: _defineProperty({}, id, updater)\n    };\n  }\n});\nstore.dispatch(incActions.increment(6)); // { counter: 16 }\n\nstore.dispatch(incActions.decrement()); // { counter: 15 }\n\nstore.dispatch(incActions.decrement(12)); // { counter: 3 }\n\n//# sourceURL=webpack:///./test.js?");
